...
public class Console extends WindowAdapter implements WindowListener, ActionListener, Runnable
{
	...
	public synchronized String readLine(PipedInputStream in) throws IOException
	{
        ...
        public synchronized void waiter(int time)
        {
               System.out.println("Hello i am here"); 
               try { this.wait(10000); }catch(Exception ie){ System.out.println(ie);} 
               System.out.println("Hello test on System.out\n");
	       System.err.println("Hello on the error output\n");
        }	
		
	public static void main(String[] arg)
	{
		Console console=new Console(); // create console with not reference	
                console.waiter(10000); 
	}			
}